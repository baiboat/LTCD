...
if __name__ == '__main__':
    GT_dir = './data/WHU_CD/test/label/'
    pred_dir = '/home/zwc/Documents/SAM-CD-main/eval/DICE-CE-Loss/SAM_CD'
    ...
    precision0 = TP / (TP+FP+1e-10)
    precision1 = TN / (TN+FN+1e-10)
    precision = (precision0+precision1)/2
    
    recall0 = TP / (TP+FN+1e-10)
    recall1 = TN / (TN+FP+1e-10)
